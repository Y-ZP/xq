    ...
    details: [
      {
        ...
        details_price: 2199,
        details_small_logo: require('@/assets/1/1.png')
      },
      {
        details_id: 112,
        details_name: 'Gree/格力 KFR-50LW 新能效变频冷暖大2匹空调柜机家用云之炫',
        details_price: 5599,
        details_small_logo: require('@/assets/1/2.webp')
      },
      {
        details_id: 113,
        details_name: 'Gree格力抽油烟机家用厨房大吸力侧吸自清洗能家电CXW-200-CCD02',
        details_price: 2599,
        details_small_logo: require('@/assets/1/3.webp')
      },
      {
        details_id: 114,
        details_name: '格力雅居大6匹一拖五GMV-H160WL家用中央空调全直流变频多联机',
        details_price: 3199,
        details_small_logo: require('@/assets/1/4.webp')
      },
      {
        details_id: 115,
        details_name: 'Gree/格力 KFR-50LW 新能效变频冷暖大2匹空调柜机家用云之炫',
        details_price: 5599,
        details_small_logo: require('@/assets/1/5.webp')
      },
      {
        details_id: 116,
      ...
      },
      {
        ...
        details_price: 4089,
        details_small_logo: require('@/assets/3/2.webp')
      },
      {
        details_id: 118,
        details_name: '小天鹅洗衣机全自动家用波轮小型8公斤大容量洗脱一体机TB80V23H',
        details_price: 1199,
        details_small_logo: require('@/assets/2/5.webp')
      },
      {
        details_id: 119,
        details_name: '美的油烟机燃气灶套餐JV703变频大吸力厨房侧吸元气套装智能家电',
        details_price: 3999,
        details_small_logo: require('@/assets/3/4.webp')
      }
    ]
  },
